...
public class overflowBiology extends AppCompatActivity {

    public LinearLayout linearLayout;
    public String tag = "BIOLOGY";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_overflow_biology);

        linearLayout = findViewById(R.id.biology_questions_holder);
        linearLayout.removeAllViews();

        FloatingActionButton addQuestion = findViewById(R.id.add_question_biology);
        ...
        addQuestion.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //It does this
                final Dialog addCommentDialog = new Dialog(overflowBiology.this);
                            ...
                            new ServerCommunicator("https://lamp.ms.wits.ac.za/~s1872817/overflowPostCat.php", contentValues) {
                                ...
                                protected void onPostExecute(String output) {
                                    ...
                                    if(output.equals("1")){
                                        ...
                                        Toast.makeText(overflowBiology.this,"Question Posted",Toast.LENGTH_SHORT).show();
                                        ...
                                        Toast.makeText(overflowBiology.this,output,Toast.LENGTH_SHORT).show();
                                    }
        ...
        new ServerCommunicator("https://lamp.ms.wits.ac.za/~s1872817/overflowQuestionsCat.php", params) {
            ...
            protected void onPostExecute(String output) {
                ...
                if(output.equals("0")){
                    ...
                    Toast.makeText(overflowBiology.this,"Can't Get Questions",Toast.LENGTH_SHORT).show();
                }
                    ...
                    try {
                        ...
                        for(int i=0;i < jsonArray.length();i++){
                            ...
                            View view = View.inflate(overflowBiology.this,R.layout.forum_questions_layout,null);
                            ...
                            commentButton.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    ...
                                    final Dialog commentDialog = new Dialog(overflowBiology.this);
                                                ...
                                                new ServerCommunicator("https://lamp.ms.wits.ac.za/~s1872817/overflowPostComment.php", contentValues) {
                                                    ...
                                                    protected void onPostExecute(String output) {
                                                        ...
                                                        if(output.equals("1")){
                                                            ...
                                                            Toast.makeText(overflowBiology.this,"Comment Posted",Toast.LENGTH_SHORT).show();
                                                            ...
                                                            Toast.makeText(overflowBiology.this,"Couldn't Comment",Toast.LENGTH_SHORT).show();
                                                        }
                                                    }
                                                }.execute();
                            ...
                            commentList.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    ...
                                    Intent intent = new Intent(overflowBiology.this,overflowComment.class);
