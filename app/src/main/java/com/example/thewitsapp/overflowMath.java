...
public class overflowMath extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_overflow_math);

        linearLayout = findViewById(R.id.math_questions_holder);
        linearLayout.removeAllViews();

        FloatingActionButton addQuestion = findViewById(R.id.add_question_math);
        ...
        addQuestion.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //It does this
                final Dialog addCommentDialog = new Dialog(overflowMath.this);
                            ...
                            new ServerCommunicator("https://lamp.ms.wits.ac.za/~s1872817/overflowPostCat.php", contentValues) {
                                ...
                                protected void onPostExecute(String output) {
                                    ...
                                    if(output.equals("1")){
                                        ...
                                        Toast.makeText(overflowMath.this,"Question Posted",Toast.LENGTH_SHORT).show();
                                        ...
                                        Toast.makeText(overflowMath.this,output,Toast.LENGTH_SHORT).show();
                                    }
        ...
        new ServerCommunicator("https://lamp.ms.wits.ac.za/~s1872817/overflowQuestionsCat.php", params) {
            ...
            protected void onPostExecute(String output) {
                ...
                if(output.equals("0")){
                    ...
                    Toast.makeText(overflowMath.this,"Can't Get Questions",Toast.LENGTH_SHORT).show();
                }
                    ...
                    try {
                        ...
                        for(int i=0;i < jsonArray.length();i++){
                            ...
                            View view = View.inflate(overflowMath.this,R.layout.forum_questions_layout,null);
                            ...
                            commentButton.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    ...
                                    final Dialog commentDialog = new Dialog(overflowMath.this);
                                                ...
                                                new ServerCommunicator("https://lamp.ms.wits.ac.za/~s1872817/overflowPostComment.php", contentValues) {
                                                    ...
                                                    protected void onPostExecute(String output) {
                                                        ...
                                                        if(output.equals("1")){
                                                            ...
                                                            Toast.makeText(overflowMath.this,"Couldn't Comment",Toast.LENGTH_SHORT).show();
                                                        }
                                                    }
                                                }.execute();
                            ...
                            commentList.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    ...
                                    Intent intent = new Intent(overflowMath.this,overflowComment.class);
