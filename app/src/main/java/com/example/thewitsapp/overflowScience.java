...
//This class will hold the questions related to science
//We are inflating in this activity
public class overflowScience extends AppCompatActivity {

    public LinearLayout linearLayout;
    public String tag = "SCIENCE";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_overflow_science);

        linearLayout = findViewById(R.id.science_questions_holder);
        linearLayout.removeAllViews();

        FloatingActionButton addQuestion = findViewById(R.id.add_question_science);
        ...
        addQuestion.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //It does this
                final Dialog addCommentDialog = new Dialog(overflowScience.this);
                            ...
                            new ServerCommunicator("https://lamp.ms.wits.ac.za/~s1872817/overflowPostCat.php", contentValues) {
                                ...
                                protected void onPostExecute(String output) {
                                    ...
                                    if(output.equals("1")){
                                        ...
                                        Toast.makeText(overflowScience.this,"Question Posted",Toast.LENGTH_SHORT).show();
                                        ...
                                        Toast.makeText(overflowScience.this,output,Toast.LENGTH_SHORT).show();
                                    }
    ...
    public void getScienceQuestion(){
        ...
        new ServerCommunicator("https://lamp.ms.wits.ac.za/~s1872817/overflowQuestionsCat.php", params) {
            ...
            if(output.equals("0")){
                ...
                Toast.makeText(overflowScience.this,"Can't Get Questions",Toast.LENGTH_SHORT).show();
            }
                ...
                try {
                    ...
                    for(int i=0;i < jsonArray.length();i++){
                        ...
                        View view = View.inflate(overflowScience.this,R.layout.forum_questions_layout,null);
                        ...
                        commentButton.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                final Dialog commentDialog = new Dialog(overflowScience.this);
                                            ...
                                            new ServerCommunicator("https://lamp.ms.wits.ac.za/~s1872817/overflowPostComment.php", contentValues) {
                                                ...
                                                protected void onPostExecute(String output) {
                                                    ...
                                                    if(output.equals("1")){
                                                        ...
                                                        Toast.makeText(overflowScience.this,"Comment Posted",Toast.LENGTH_SHORT).show();
                                                        ...
                                                        Toast.makeText(overflowScience.this,"Couldn't Comment",Toast.LENGTH_SHORT).show();
                                                    }
                                                }
                                            }.execute();
                        ...
                        commentList.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                Intent intent = new Intent(overflowScience.this,overflowComment.class);
