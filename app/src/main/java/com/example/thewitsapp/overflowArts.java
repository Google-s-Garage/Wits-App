...
public class overflowArts extends AppCompatActivity {

    public LinearLayout linearLayout;
    public String tag = "ARTS";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_overflow_arts);

        linearLayout = findViewById(R.id.arts_questions_holder);
        linearLayout.removeAllViews();

        FloatingActionButton addQuestion = findViewById(R.id.add_question_arts);
        ...
        addQuestion.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //It does this
                final Dialog addCommentDialog = new Dialog(overflowArts.this);
                            ...
                            new ServerCommunicator("https://lamp.ms.wits.ac.za/~s1872817/overflowPostCat.php", contentValues) {
                                ...
                                protected void onPostExecute(String output) {
                                    ...
                                    if(output.equals("1")){
                                        ...
                                        Toast.makeText(overflowArts.this,"Question Posted",Toast.LENGTH_SHORT).show();
                                        ...
                                        Toast.makeText(overflowArts.this,output,Toast.LENGTH_SHORT).show();
                                    }
        ...
        new ServerCommunicator("https://lamp.ms.wits.ac.za/~s1872817/overflowQuestionsCat.php", params) {
            ...
            protected void onPostExecute(String output) {
                ...
                if(output.equals("0")){
                    ...
                    Toast.makeText(overflowArts.this,"Can't Get Questions",Toast.LENGTH_SHORT).show();
                }
                    ...
                    try {
                        ...
                        for(int i=0;i < jsonArray.length();i++){
                            ...
                            View view = View.inflate(overflowArts.this,R.layout.forum_questions_layout,null);
                            ...
                            commentButton.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    ...
                                    final Dialog commentDialog = new Dialog(overflowArts.this);
                                                ...
                                                new ServerCommunicator("https://lamp.ms.wits.ac.za/~s1872817/overflowPostComment.php", contentValues) {
                                                    ...
                                                    protected void onPostExecute(String output) {
                                                        ...
                                                        if(output.equals("1")){
                                                            ...
                                                            Toast.makeText(overflowArts.this,"Comment Posted",Toast.LENGTH_SHORT).show();
                                                            ...
                                                            Toast.makeText(overflowArts.this,"Couldn't Comment",Toast.LENGTH_SHORT).show();
                                                        }
                                                    }
                                                }.execute();
                            ...
                            commentList.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    ...
                                    Intent intent = new Intent(overflowArts.this,overflowComment.class);
